...
- [CS2106 Notes AY23/24 Sem2](#cs2106-notes-ay2324-sem2)
  ...
  - [Virtual Memory Management](#virtual-memory-management)
    ...
    - [Page Replacement Algorithms](#page-replacement-algorithms)
      ...
      - [Second-Chance Page Replacement (aka CLOCK)](#second-chance-page-replacement-aka-clock)
  ...
  - [File Management](#file-management)
    ...
    - [Directory](#directory)
    - [File System Implementations](#file-system-implementations)
      - [File Block Allocation](#file-block-allocation)
      - [Free Space Management](#free-space-management)
      - [Implementing Directory](#implementing-directory)
...
- ![invertedPageTable](invertedPageTable.png)
...
- ![fileDataGenericOperations](fileDataGenericOperations.png)
- OS provides file operations as system calls
  - Provide proection, concurrent and efficient access
- ![fileOperationsSystemCalls](fileOperationsSystemCalls.png)
...
- ![fileOperations](fileOperations.png)
...
- ![genericDiskOrganization](genericDiskOrganization.png)
...
- File allocation table (FAT)
  - ![FatAllocation](FatAllocation.png)
...
- I-Node Data
  ...
  - ![iNodeDataBlock](iNodeDataBlock.png)
